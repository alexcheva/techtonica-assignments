...
function exercise1(num1) {
  ...
  if(num1 > 10){
    anwer1 = `The value of num1 is ${num1} is greater than 10`;
  }
  // ------------------------------------------
  // And above here
  // ------------------------------------------
...
// exercise4(true, 1) with == would be equal, or 1 and "1" with == would be equal. But with === it's not a problem.
...
// It was alright. Had to look up exercise 2 (how to find out if number is odd or even) and revise how to use the remainer operatior. 
// Also run a few problems in the console to make sure they are correct.
